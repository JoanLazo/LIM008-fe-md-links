...
exports.statsOption = exports.brokenLinks = exports.uniqueLinks = exports.validateOption = exports.readFilesMd = exports.isDirOrFile = exports.convertInAbsolute = exports.pathAbsolute = void 0;
...
var uniqueLinks = function uniqueLinks(arrObjLinksValidate) {
  var newSetLinks = _toConsumableArray(new Set(arrObjLinksValidate.map(function (links) {
    return links.href;
  })));
...
var statsOption = function statsOption(arrObjLinksValidate) {
  var totalLinks = arrObjLinksValidate.length;
  return totalLinks;
...
exports.statsOption = statsOption;
validateOption(readFilesMd(isDirOrFile("C:\\Users\\Laboratoria\\Documents\\PROYECTO MARKDOWN\\LIM008-fe-md-links\\test\\prueba"))).then(function (res) {
  console.log(res);
});